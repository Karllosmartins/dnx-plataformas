...
-- Versão para Supabase (sem comandos psql)
-- =====================================================
...
DROP POLICY IF EXISTS "tipos_negocio_read_policy" ON public.tipos_negocio;
CREATE POLICY "tipos_negocio_read_policy" ON public.tipos_negocio
  FOR SELECT USING (ativo = true);

DROP POLICY IF EXISTS "tipos_negocio_admin_policy" ON public.tipos_negocio;
...
DROP POLICY IF EXISTS "user_tipos_negocio_policy" ON public.user_tipos_negocio;
