-- Migration: Adicionar acesso_integracoes na view_usuarios_planos
-- Data: 2025-10-05
-- Descrição: Incluir campo acesso_integracoes que estava faltando na view

-- Recriar a view incluindo acesso_integracoes
...
SELECT
    ...
    p.acesso_consulta,
    p.acesso_usuarios,
    p.acesso_integracoes,  -- CAMPO ADICIONADO
    u.created_at,
    u.updated_at
FROM
    users u
...
-- Comentário na view
COMMENT ON VIEW view_usuarios_planos IS 'View que combina dados de usuários com informações dos planos incluindo consumo de recursos e todas as permissões';
